...
- **`stubs/package.json`'s `@tiptap/*` packages moved from `^3.22.4` to `^3.30.4`** to pick up upstream fixes; `stubs/package-lock.json` regenerated. No used API changed across that range.
